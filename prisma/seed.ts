...
async function main() {
  ...
  await client.execute({
    ...
    args: [
      ...
      `<p>Every love story starts somewhere — theirs just happens to start with a mirror selfie and a playful threat to report it. What began as two strangers trading messages became a first date, and a first date became the kind of life neither of them expected. This is how it happened.</p>
