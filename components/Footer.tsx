      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            {settings?.weddingHashtag && (
              <p className="text-gold-light text-lg font-medium mb-2">
                {settings.weddingHashtag}
              </p>
            )}
          ...
          <div className="text-center">
            <h4 className="text-ivory font-serif text-lg mb-4">
              Quick Links
            </h4>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="space-y-2">
              ...
              {settings?.photoShareLink && (
                <a
                  href={settings.photoShareLink}
                  target="_blank"
        ...
        <div className="border-t border-gold/10 pt-8 text-center">
          <p className="text-ivory/40 text-sm">
            ...
            {settings?.coupleName || "Jacob & Ashley"} • Made with ♥
          </p>
        </div>
      </div>
    </footer>
